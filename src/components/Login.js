    ...
    <div className="loginForm">
        ...
        >
            <div className="mb-1 flex items-center justify-between gap-3">
                <label className="text-indigo-200/65 mb-1 block text-sm font-medium" htmlFor="email">
                    Email
                </label>
            </div>
            <input id="username" type="text" className="form-input w-full" placeholder="Your email" 
            ...
            <div>
                <div className="mb-1 flex items-center justify-between gap-3">
                    <label className="text-indigo-200/65 block text-sm font-medium" htmlFor="password">
                        Password
                    </label>
                </div>
                <input
        ...
        <Link to={"/signup"} className="font-medium text-indigo-500 cursor-pointer">
          Sign Up
        </Link>
      </div>
    </div>
